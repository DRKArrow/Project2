...
================================================================================*/
  ...
  $(function() {
    ...
    var navbar_check = localStorage.getItem("navbar");
          if(navbar_check == 'false'){
            $('#left-sidebar-nav').removeClass('nav-lock').addClass('nav-collapsed');
            $('#main').addClass('main-full');
            $('.navbar-toggler').children().html('radio_button_unchecked');
